...
<img src="https://socialify.git.ci/amit-tiwari-online/Fake-News-Detection/image?description=1&font=Source%20Code%20Pro&forks=1&issues=1&language=1&name=1&owner=1&pattern=Charlie%20Brown&pulls=1&stargazers=1&theme=Dark" alt="Fake-News-Detection" width="1280" height="320" />
...
```bash
git clone https://github.com/amit-tiwari-online/Fake-News-Detection.git
```
